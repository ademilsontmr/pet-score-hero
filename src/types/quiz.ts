...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Algumas vezes por semana", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, sempre!", points: 5 },
      { text: "Quando posso", points: 3 },
      { text: "Raramente", points: 1 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, vários brinquedos e atividades", points: 4 },
  ...
  },
  {
    ...
    options: [
      { text: "Com treinamento positivo", points: 5 },
      { text: "Com paciência e observação", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, caminha própria e confortável", points: 4 },
      { text: "Dorme no sofá ou na cama", points: 3 },
      { text: "Dorme no chão", points: 1 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, rotina completa", points: 5 },
      { text: "Só banho regular", points: 3 },
      { text: "Raramente", points: 1 },
      { text: "Quase nunca", points: 0 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, e busco ajuda quando necessário", points: 5 },
      { text: "Observo mas nem sempre sei como ajudar", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Seguro e adaptado para ele", points: 5 },
      { text: "Razoavelmente seguro", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, microchip e plaquinha", points: 5 },
      { text: "Só plaquinha", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "É um membro da família", points: 5 },
      { text: "Gosto muito dele", points: 3 },
      { text: "É uma companhia", points: 1 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, leio e busco informações", points: 4 },
  ...
  },
  {
    ...
    options: [
      { text: "Não, sempre tem companhia", points: 5 },
      { text: "Algumas horas por dia", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, sempre", points: 5 },
      { text: "Na maioria das vezes", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Uso petiscos saudáveis com moderação", points: 5 },
      { text: "Dou petiscos normais às vezes", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, tenho uma galeria cheia!", points: 4 },
      { text: "Às vezes tiro fotos", points: 2 },
      { text: "Raramente", points: 1 },
      { text: "Nunca", points: 0 }
    ]
  },
  {
    ...
    options: [
      { text: "Sim, quintal ou passeios regulares", points: 4 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, o tempo todo!", points: 5 },
  ...
  },
  {
    ...
    options: [
      { text: "Com paciência e redirecionamento", points: 5 },
      { text: "Com calma, mas fico chateado", points: 3 },
  ...
  },
  {
    ...
    options: [
      { text: "Sim, sempre penso nele primeiro", points: 5 },
      { text: "Considero, mas não é prioridade", points: 3 },
...
export const getQuizResult = (score: number): QuizResult => {
  if (score >= 90) {
    ...
    return {
      ...
      description: "Seu pet te vê como um super-herói! Vocês têm conexão, cuidado, rotina e muito amor. Você dedica tempo, atenção e sempre busca o melhor para ele. Continue assim – você está fazendo um trabalho maravilhoso! 🐾💚",
      tips: [
        "Explore novas atividades e brincadeiras",
        "Continue com a rotina de saúde preventiva",
        "Considere enriquecer ainda mais o ambiente dele",
        "Registre esses momentos especiais juntos"
      ]
    };
  } else if (score >= 60) {
    return {
